...
from epivizFileParser import BaseFile, BigBed, BigWig, SamFile, BamFile, TbxFile, GtfFile, HDF5File, GtfParsedFile, GWASBigBedPIP, GWASBigBedPval, InteractionBigBed, TranscriptTbxFile
